	  ...
	  <div class="container-fluid">
	    ...
	    <div class="navbar-collapse collapse navbar-inverse-collapse">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="hover-ul"><a href="organization.jsp#Repositories">Repositories</a></li>
	        <li class="hover-ul"><a href="organization.jsp#CreateNew">Create New Repository</a></li>
